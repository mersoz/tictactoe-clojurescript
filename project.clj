(defproject tictactoe "0.1.0-SNAPSHOT"
  :description "Tic tac toe game in ClojureScript, using reagent. Following a tutorial found on http://practicalli.github.io/clojurescript/reagent-projects/tic-tac-toe/"
